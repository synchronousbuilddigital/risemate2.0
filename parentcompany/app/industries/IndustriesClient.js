            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-full text-[10px] md:text-xs font-black uppercase tracking-wider border transition-all duration-300 ${isActive
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[1.1] mb-8 font-primary">
                Why Industries Choose <br /> RiseMates Ventures
              </h2>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        <div className="container-wide text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-500 font-secondary leading-relaxed mb-12">
            Whether you're transforming an established enterprise, scaling an innovative startup, or expanding into new markets, RiseMates Ventures provides the expertise, partnerships, and execution capabilities to help you achieve your growth ambitions.
          </p>
          <Link
            href="/contact"
