...
const LOCATIONS = [
  ...
  { id: "delhi", name: "NEW DELHI", type: "RiseMatesS HQ", focus: "Corporate Governance / Venture Policy", coords: { x: "36.8%", y: "27.8%" } },
      ...
      <main className="animate-page-in pt-32 px-8 md:px-24">
        ...
        <footer className="bg-dark py-12 border-t border-white/5">
          <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 px-8 md:px-0">
            ...
            <p className="font-body text-[10px] uppercase tracking-widest opacity-20">© 2024 RiseMatesS VENTURES. OPERATIONAL FOOTPRINT.</p>
          </div>
        </footer>
      </main>
    </div>
