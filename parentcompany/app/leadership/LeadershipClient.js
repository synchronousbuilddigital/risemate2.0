      ...
      <div className="relative lg:w-[38%] overflow-hidden bg-[#001233] lg:min-h-full h-[600px]">
        ...
        {leader.logo && (
          <div className="absolute bottom-8 right-8 z-20">
            <div className={`w-14 h-14 bg-white rounded-2xl shadow-xl p-3 border border-dark/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-700`}>
  ...
  return (
    <div className="bg-white">
      ...
      <section ref={heroRef} className="relative min-h-[50vh] flex flex-col justify-center overflow-hidden py-10 md:py-16 px-6 md:px-24 bg-[#FAF9F6]">
        ...
        <div className="max-w-[1700px] mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Text */}
          <div>
            <motion.span
      ...
      <section className="relative">
        {dynamicLeaders.map((leader, i) => (
          <LeaderRow key={leader.id || i} leader={leader} reverse={i % 2 !== 0} />
        ))}
      </section>

      {/* Unified Mandate Banner */}
      <section className="relative py-20 md:py-32 overflow-hidden bg-dark text-white text-center">
        ...
        <div className="container-wide relative z-10">
          ...
          <p className="text-xl md:text-2xl text-white/35 font-secondary max-w-3xl mx-auto italic mb-16 leading-relaxed">
            "Our leadership is defined not by individual success, but by the performance of the conglomerate as a unified architectural unit."
          </p>

          <Link
            href="/contact"
            className="inline-flex items-center gap-5 group bg-white text-dark px-12 py-5 rounded-full text-[10px] font-black uppercase tracking-[0.45em] hover:bg-[#002366] hover:text-white transition-all duration-700 shadow-lg"
          >
