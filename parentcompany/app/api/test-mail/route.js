...
export async function GET() {
    try {
        const result = await sendEmail({
            to: 'biz@RiseMatessventures.com',
            subject: 'RiseMatess Ventures - SMTP Verification Test',
            ...
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; padding: 20px; border: 1px solid #C9A84C; border-radius: 8px;">
                    ...
                    <p style="color: #666; font-size: 12px; margin-top: 20px;">RiseMatess Ventures Mail System</p>
                </div>
            `
        });
