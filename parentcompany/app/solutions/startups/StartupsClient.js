...
const challenges = [
  "Product-market fit", "Go-to-market strategy", "Revenue generation", 
  "Investor readiness", "Business model refinement", "Team building", 
  "Market expansion", "Partnership development", "Technology implementation", 
  "Scaling operations"
];
...
const solutions = [
  "Business Strategy", "Mentorship", "Funding Readiness", "Market Expansion", 
  "Corporate Partnerships", "Technology Enablement", "AI Adoption", "Growth Advisory"
];
        ...
        <div className="container-wide relative z-10 w-full text-center max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-black">Startups</span>
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black leading-[1.05] text-black tracking-tighter mb-8 font-primary">
              Building Tomorrow's <br />
              <span className="text-gold">Global Businesses.</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-500 font-secondary leading-relaxed mb-12">
              Helping founders validate ideas, attract investment, build partnerships, and scale confidently from concept to global growth.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white border-b border-gray-200">
        <div className="container-wide">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-black leading-snug font-primary">
              Every Great Business Starts With One Opportunity.
            </h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-wide">
          <div className="bg-black text-white rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter leading-tight mb-10 font-primary relative z-10">
              Let's Build the Next Great Business Together.
            </h2>
